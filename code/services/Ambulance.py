...
coor = ""
subtopic = [
"hshl/mqtt_exercise/services/ambulance/back",
...
def processing(msg):
    ...
    global name
    js = json.loads(msg[1])
    if "hshl/mqtt_exercise/services/ambulance/back" == msg[0] and str(js['name']) == str(name):
        id = js['id']
        print(id)
    elif msg[0] == "hshl/mqtt_exercise/services/ambulance/"+str(id)+"/call":                      #koordinaten des users
        ...
        send(json.dumps(data),"hshl/mqtt_exercise/services/ambulance/"+str(id)+"/call/back") # senden der nachricht
        subtopic.append("hshl/mqtt_exercise/services/ambulance/"+str(id)+"/call/destination") #aufnehmen des neuen topics in das topic array
        receive() #warten auf antwort
    elif msg[0] == "hshl/mqtt_exercise/services/ambulance/"+str(id)+"/call/destination":      #zielkoordinaten
        ...
        send(json.dumps(data),"hshl/mqtt_exercise/services/ambulance/"+id+"/call/destination/back") # senden der erreicht nachricht für das ziel
