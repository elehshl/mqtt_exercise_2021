...
#ServiceCar Feedack For Arrival At User And Arrival At Destination
    elif msg[0] == "hshl/mqtt_exercise/"+topictype+str(idCar)+"/call/back" and str(js['msg']).upper == "arrival": # antwort vom servicefahrzeug das angeschrieben wurde
        destination = ""
        ...
        receive() # warten auf antwort
    elif msg[0] == "hshl/mqtt_exercise/"+topictype+str(idCar)+"/call/destination/back" and str(js['msg']).upper == "arrival at destination": #rückmeldung über ankunft am ziel
