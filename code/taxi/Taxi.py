...
def receive():
    ...
    def on_connect(client, userdata, flags, rc):
        ...
        client.subscribe("hshl/mqtt_exercise/taxi/"+str(id)+"/order/back", 2)
...
def processing(array):
    ...
    if "hshl/mqtt_exercise/taxi/back" == array[0] and str(js['name']) == str(name):
        id = js['id']
...
def registration():
    ...
    send("hshl/mqtt_exercise/taxi", json.dumps(data))
    receive()
